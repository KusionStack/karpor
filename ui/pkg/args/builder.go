...
// SetStaticDir 'static-dir' argument of Dashboard binary.
func (self *holderBuilder) SetStaticDir(staticDir string) *holderBuilder {
	self.holder.staticDir = staticDir
	return self
}

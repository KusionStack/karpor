...
const AgentYaml = (props: IProps) => {
  const { t } = useTranslation()
  const handle = useFullScreenHandle()
  const yamlRef = useRef<LegacyRef<HTMLDivElement> | any>()
  ...
  useEffect(() => {
    if (yamlRef.current && data) {
      yamlRef.current.textContent = data

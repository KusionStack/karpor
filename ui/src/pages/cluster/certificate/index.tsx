...
const ClusterCertificate = () => {
  ...
  // const newYamlContentStatusJson = yaml2json(newYamlContent);
  // const oldYaml = yaml.dump(yamlStatusJson?.data);
  // const newYaml = yaml.dump(newYamlContentStatusJson?.data);

...
import { Collapse, DatePicker, Drawer, Input, Pagination, Select, Tag } from "antd";
import { CaretRightOutlined, ClockCircleOutlined, SearchOutlined } from "@ant-design/icons";
          ...
          <div className={styles.collapse_panel_body}>
            <div className={styles.body}>
              ...
              <div className={styles.value}>{item?.timeList?.map(item => {
                return <div key={item} className={styles.time_block}>
                  {item}
                </div>
              })}</div>
            </div>

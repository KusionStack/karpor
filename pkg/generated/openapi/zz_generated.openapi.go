...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.Cluster":                      schema_pkg_apis_cluster_v1beta1_Cluster(ref),
		"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterAccess":                schema_pkg_apis_cluster_v1beta1_ClusterAccess(ref),
		"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterAccessCredential":      schema_pkg_apis_cluster_v1beta1_ClusterAccessCredential(ref),
		"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterList":                  schema_pkg_apis_cluster_v1beta1_ClusterList(ref),
		...
		"github.com/KusionStack/karbour/pkg/apis/search/v1beta1.ClusterResourcesSyncCondition": schema_pkg_apis_search_v1beta1_ClusterResourcesSyncCondition(ref),
...
func schema_pkg_apis_cluster_v1beta1_Cluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterSpec", "github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_cluster_v1beta1_ClusterAccess(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"credential": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterAccessCredential"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterAccessCredential"},
	}
}
...
func schema_pkg_apis_cluster_v1beta1_ClusterAccessCredential(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"x509": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.X509"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.X509"},
	}
}
...
func schema_pkg_apis_cluster_v1beta1_ClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.Cluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.Cluster", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_cluster_v1beta1_ClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/cluster/v1beta1.ClusterAccess"},
	}
}
...
func schema_pkg_apis_search_v1beta1_ClusterResourcesSyncCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/KusionStack/karbour/pkg/apis/search/v1beta1.ResourceSyncCondition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/search/v1beta1.ResourceSyncCondition"},
	}
}
...
func schema_pkg_apis_search_v1beta1_Selector(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"fieldSelector": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/KusionStack/karbour/pkg/apis/search/v1beta1.FieldSelector"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/search/v1beta1.FieldSelector", "k8s.io/apimachinery/pkg/apis/meta/v1.LabelSelector"},
	}
}
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/KusionStack/karbour/pkg/apis/search/v1beta1.ResourceSyncRule"),
									},
								},
							},
						},
...
func schema_pkg_apis_search_v1beta1_SyncRegistryStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/KusionStack/karbour/pkg/apis/search/v1beta1.ClusterResourcesSyncCondition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/search/v1beta1.ClusterResourcesSyncCondition", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/KusionStack/karbour/pkg/apis/search/v1beta1.SyncResourcesSpec"),
						},
					},
				},
			},
...
func schema_pkg_apis_search_v1beta1_SyncResourcesList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/KusionStack/karbour/pkg/apis/search/v1beta1.SyncResources"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/search/v1beta1.SyncResources", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_search_v1beta1_SyncResourcesSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/search/v1beta1.ResourceSyncRule"},
	}
}
...
func schema_pkg_apis_search_v1beta1_TransformRuleList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/KusionStack/karbour/pkg/apis/search/v1beta1.TransformRule"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/KusionStack/karbour/pkg/apis/search/v1beta1.TransformRule", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

...
type ClusterExtensionInterface interface {
	Create(ctx context.Context, clusterExtension *v1beta1.ClusterExtension, opts v1.CreateOptions) (*v1beta1.ClusterExtension, error)
	Update(ctx context.Context, clusterExtension *v1beta1.ClusterExtension, opts v1.UpdateOptions) (*v1beta1.ClusterExtension, error)
	UpdateStatus(ctx context.Context, clusterExtension *v1beta1.ClusterExtension, opts v1.UpdateOptions) (*v1beta1.ClusterExtension, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ClusterExtension, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ClusterExtensionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterExtension, err error)
...
func newClusterExtensions(c *ClusterV1beta1Client) *clusterExtensions {
...
func (c *clusterExtensions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ClusterExtension, err error) {
	result = &v1beta1.ClusterExtension{}
	err = c.client.Get().
...
func (c *clusterExtensions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ClusterExtensionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ClusterExtensionList{}
	err = c.client.Get().
		Resource("clusterextensions").
...
func (c *clusterExtensions) Create(ctx context.Context, clusterExtension *v1beta1.ClusterExtension, opts v1.CreateOptions) (result *v1beta1.ClusterExtension, err error) {
	result = &v1beta1.ClusterExtension{}
	err = c.client.Post().
		Resource("clusterextensions").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterExtensions) Update(ctx context.Context, clusterExtension *v1beta1.ClusterExtension, opts v1.UpdateOptions) (result *v1beta1.ClusterExtension, err error) {
	result = &v1beta1.ClusterExtension{}
	err = c.client.Put().
		Resource("clusterextensions").
...
func (c *clusterExtensions) UpdateStatus(ctx context.Context, clusterExtension *v1beta1.ClusterExtension, opts v1.UpdateOptions) (result *v1beta1.ClusterExtension, err error) {
	result = &v1beta1.ClusterExtension{}
	err = c.client.Put().
		Resource("clusterextensions").
		Name(clusterExtension.Name).
...
func (c *clusterExtensions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterExtension, err error) {
	result = &v1beta1.ClusterExtension{}

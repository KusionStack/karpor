...
// ClusterV1Client is used to interact with features provided by the cluster.karbour.com group.
type ClusterV1Client struct {
	restClient rest.Interface
}

func (c *ClusterV1Client) ClusterExtensions() ClusterExtensionInterface {

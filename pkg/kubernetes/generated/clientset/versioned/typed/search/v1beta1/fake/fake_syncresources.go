...
func (c *FakeSyncResourceses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.SyncResources, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(syncresourcesesResource, name), &v1beta1.SyncResources{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncResources), err
}
...
func (c *FakeSyncResourceses) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.SyncResourcesList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(syncresourcesesResource, syncresourcesesKind, opts), &v1beta1.SyncResourcesList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1beta1.SyncResourcesList{ListMeta: obj.(*v1beta1.SyncResourcesList).ListMeta}
	for _, item := range obj.(*v1beta1.SyncResourcesList).Items {
...
func (c *FakeSyncResourceses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(syncresourcesesResource, opts))
}
...
func (c *FakeSyncResourceses) Create(ctx context.Context, syncResources *v1beta1.SyncResources, opts v1.CreateOptions) (result *v1beta1.SyncResources, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(syncresourcesesResource, syncResources), &v1beta1.SyncResources{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncResources), err
...
func (c *FakeSyncResourceses) Update(ctx context.Context, syncResources *v1beta1.SyncResources, opts v1.UpdateOptions) (result *v1beta1.SyncResources, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(syncresourcesesResource, syncResources), &v1beta1.SyncResources{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncResources), err
...
func (c *FakeSyncResourceses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(syncresourcesesResource, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.SyncResourcesList{})
	return err
}
...
func (c *FakeSyncResourceses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.SyncResources, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(syncresourcesesResource, name, pt, data, subresources...), &v1beta1.SyncResources{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncResources), err

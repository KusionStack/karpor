...
var syncregistriesResource = schema.GroupVersionResource{Group: "search.karpor.io", Version: "v1beta1", Resource: "syncregistries"}

var syncregistriesKind = schema.GroupVersionKind{Group: "search.karpor.io", Version: "v1beta1", Kind: "SyncRegistry"}
...
func (c *FakeSyncRegistries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.SyncRegistry, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(syncregistriesResource, name), &v1beta1.SyncRegistry{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncRegistry), err
}
...
func (c *FakeSyncRegistries) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.SyncRegistryList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(syncregistriesResource, syncregistriesKind, opts), &v1beta1.SyncRegistryList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1beta1.SyncRegistryList{ListMeta: obj.(*v1beta1.SyncRegistryList).ListMeta}
	for _, item := range obj.(*v1beta1.SyncRegistryList).Items {
...
func (c *FakeSyncRegistries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(syncregistriesResource, opts))
}
...
func (c *FakeSyncRegistries) Create(ctx context.Context, syncRegistry *v1beta1.SyncRegistry, opts v1.CreateOptions) (result *v1beta1.SyncRegistry, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(syncregistriesResource, syncRegistry), &v1beta1.SyncRegistry{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncRegistry), err
...
func (c *FakeSyncRegistries) Update(ctx context.Context, syncRegistry *v1beta1.SyncRegistry, opts v1.UpdateOptions) (result *v1beta1.SyncRegistry, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(syncregistriesResource, syncRegistry), &v1beta1.SyncRegistry{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncRegistry), err
...
func (c *FakeSyncRegistries) UpdateStatus(ctx context.Context, syncRegistry *v1beta1.SyncRegistry, opts v1.UpdateOptions) (*v1beta1.SyncRegistry, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(syncregistriesResource, "status", syncRegistry), &v1beta1.SyncRegistry{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncRegistry), err
...
func (c *FakeSyncRegistries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(syncregistriesResource, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.SyncRegistryList{})
	return err
}
...
func (c *FakeSyncRegistries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.SyncRegistry, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(syncregistriesResource, name, pt, data, subresources...), &v1beta1.SyncRegistry{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SyncRegistry), err

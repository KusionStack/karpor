...
// ResourceGraphNode GetHash method returns the hash of the resource graph node.
func (rgn ResourceGraphNode) GetHash() string {
	return rgn.Group + "/" + rgn.Version + "." + rgn.Kind + ":" + rgn.Namespace + "." + rgn.Name
}

// RelationshipGraphNode GetHash method returns the hash of the relationship graph node.
func (rgn RelationshipGraphNode) GetHash() string {
	return rgn.Group + "." + rgn.Version + "." + rgn.Kind
}

// Relationship GetHash method returns the hash of the relationship.
func (r Relationship) GetHash() string {
	return r.Group + "." + r.Version + "." + r.Kind
}

// RelationshipGraphNode ConvertToMap method converts the relationship graph node to a map[string]string.

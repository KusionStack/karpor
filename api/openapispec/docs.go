...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/pkg_core_handler_scanner.AuditData"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_KusionStack_karbour_pkg_core_manager_insight.ScoreData"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "github_com_KusionStack_karbour_pkg_core_manager_insight.ScoreData": {
            "type": "object",
            "properties": {
                "issuesTotal": {
        ...
        "github_com_KusionStack_karbour_pkg_infra_scanner.Issue": {
            "type": "object",
            "properties": {
                "message": {
                ...
                "severity": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_KusionStack_karbour_pkg_infra_scanner.IssueSeverityLevel"
                        }
                    ]
                },
                "title": {
        ...
        "github_com_KusionStack_karbour_pkg_infra_scanner.IssueSeverityLevel": {
            "type": "integer",
            "enum": [
                0,
                1,
        ...
        "pkg_core_handler_scanner.AuditData": {
            "type": "object",
            "properties": {
                "bySeverity": {
                    "type": "object",
                ...
                "issueGroups": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/pkg_core_handler_scanner.IssueGroup"
                    }
                },
                "issueTotal": {
                    "type": "integer"
        ...
        "pkg_core_handler_scanner.IssueGroup": {
            "type": "object",
            "properties": {
                "issue": {
                    "$ref": "#/definitions/github_com_KusionStack_karbour_pkg_infra_scanner.Issue"
                },
                "locators": {
                    "type": "array",
                    "items": {
